""" Programacion-3
Juan Blanco,Felipe Mendivelso,Kevin Mora mec-A"""
...
while True: 
    ...
    if Opcion == "1":
        ...
        print("Bienvenido a la Raíz Enésima")
        Numero1 = int(input("Ingrese el número: "))
        R1 = int(input("Ingrese la raíz: "))

        if Numero1 < 0 and R1 % 2 == 0:
            print("Error: el resultado es un número imaginario")
        else:
            Raiz1 = Numero1 ** (1 / R1)
            print("La raíz", R1, "del número", Numero1, "es:", Raiz1)
    ...
    if not ( Respuesta=="sI" or Respuesta=="SI" or Respuesta=="Si" or Respuesta=="si"):
